...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openff-units-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12845&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openff-units-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openff-units` can be installed with:

```
conda install openff-units
```

It is possible to list all of the versions of `openff-units` available on your platform with:
